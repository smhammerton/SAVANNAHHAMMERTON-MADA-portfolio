...
```{r echo=FALSE, fig.cap="In Geneva, Switzerland in February 2020 during a trip to Germany and Switzerland to see family. I think this is the most beautiful place I've ever been!"}
knitr::include_graphics(here::here('images', 'IMG_5631.jpg'))
```
